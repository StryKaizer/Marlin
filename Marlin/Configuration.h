...
#define STRING_CONFIG_H_AUTHOR "(StryKaizer, P3Steel XL)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,8000,1550}  // default steps per unit for DRV8825
#define DEFAULT_MAX_FEEDRATE          {400, 400, 2, 45}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {5000,5000,20,5000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
